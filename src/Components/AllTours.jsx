...
const AllTours = () => {
  ...
  return (
    <div className="font-poppins md:mt```jsx
import React from "react";
import SubscriptionForm from "./SubscriptionForm";
...
const AllTours = () => {
  return (
    <div className="font-poppins md:mt-[-175px] mt-[-230px]">
      ...
      <div className="relative -mt-12 z-10 flex justify-center px-4"></div>
          ...
          {toursData.map((tour, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-blackOverlay rounded-lg">
                ...
                {tour.location && (
                  <p className="text-white text-lg md:text-xl">{tour.location}</p>
                )}
              </div>
            </div>
          ))}
...
const toursData = [
  {
    image: "/image/Rectangle 22@3x.png",
    name: "Dubai",
    location: "UAE",
  },
  {
  ...
  {
    image: "/image/Rectangle 24 (2).png",
    name: "Australia",
  },
  {
    image: "/image/Rectangle 24 (3).png",
    name: "Indonesia",
  },
  {
    image: "/image/Rectangle 24 (4).png",
    name: "China",
  },
  {
    image: "/image/taj.jpg",
  ...
  {
    image: "/image/Rectangle 24 (5).png",
    name: "Maldives",
  },
  {
    image: "/image/Rectangle 24@2x.png",
    name: "Thailand",
  },
  {
